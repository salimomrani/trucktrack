...
- [X] T177 [P] Create Prometheus alert rules in infra/monitoring/prometheus/alerts.yml (high Kafka lag, API latency spike, service down)
- [X] T178 [P] Setup OpenTelemetry distributed tracing in all services (add dependencies + configuration)
